...
with tab1:
    ...
    with col1:
        ...
        st.image("images/uni1.png", caption="Distribution of Candidate Sex")
        
        st.subheader("Distribution of Candidate Age")
        st.image("images/uni2.png", caption="Distribution of Candidate Age")
        
        st.subheader("Top 15 Parties by Candidate Count")
        st.image("images/uni3.png", caption="Top 15 Parties by Candidate Count")
        
    with col2:
        st.subheader("Winning Margin %")
        st.image("images/uni4.png", caption="Winning Margin")

        st.subheader("Voter Turnout %")
        st.image("images/uni5.png", caption="Voter Turnout")
        
        st.subheader("Distribution of Winning Margin")
        st.image("images/uni6.png", caption="Winning Margin %")

    st.divider()
    
    st.subheader("Top 15 states by Number of Female Candidates Winning Elections(2009-2021)")
    st.image("images/uni7.png", caption="Total Number of Female Winners")
...
with tab2:
    ...
    with col1:
        ...
        st.image("images/bi1.png", caption="Party-Wise")
        
        st.subheader("Top 15 parties by Strike Rate")
        st.image("images/bi3.png", caption="Party-Wise")
        
        st.subheader("Candidates Contesting Over the Years")
        st.image("images/bi4.png", caption="For each year")

    with col2:
        st.subheader("Total Electors vs. Election Outcome")
        st.image("images/bi5.png", caption="Total Electors vs. Election Outcome")
        
        st.subheader("Age Distribution of Candidates for Major Parties")
        st.image("images/bi7.png", caption="For Every Party")
        
        st.subheader("Density of Wins in Indian States for BJP")
        st.image("images/bi8.png", caption="BJP Win Rate")
...
with tab3:
    ...
    st.image("images/mul1.png", caption="Correlation Matrix of Key Features")
...
with tab5:
    ...
    try:
        st.image("images/logistic.png", caption="Analysis of the Logistic Regression model (e.g., Confusion Matrix)")
    except FileNotFoundError:
